...
Block.toRGBA = {
      ...
      STAIRS_COBBLESTONE: (123, 123, 123, 255),
      ...
      DOOR_WOOD: (134, 102, 51, 255),
      WOOD_BUTTON: (134, 102, 51, 255),
      ...
      FURNACE_ACTIVE: (125,102,85,255),
      FURNACE_INACTIVE: (78,78,78,255),
      GLASS: (60, 67, 68, 64),
      GLASS_PANE: (200, 255, 255, 64),
      GLOWSTONE_BLOCK: (144,118,70,255),
      ...
      LAVA_FLOWING: (207,92,20,255),
      LAVA_STATIONARY: (212,90,18,255),
      LEAVES_ACACIA_PERMANENT: (82,82,82,255),
      LEAVES_ACACIA_DECAYABLE: (82,82,82,255),
      LEAVES_DARK_OAK_PERMANENT: (82,82,82,255),
      LEAVES_DARK_OAK_DECAYABLE: (82,82,82,255),
      LEAVES_BIRCH_PERMANENT: (82,82,82,255),
      LEAVES_BIRCH_DECAYABLE: (82,82,82,255),
      LEAVES_JUNGLE_PERMANENT: (115,113,106,255),
      LEAVES_JUNGLE_DECAYABLE: (115,113,106,255),
      LEAVES_OAK_PERMANENT: (82,82,82,255),
      LEAVES_OAK_DECAYABLE: (82,82,82,255),
      LEAVES_SPRUCE_PERMANENT: (75,75,75,255),
      LEAVES_SPRUCE_DECAYABLE: (75,75,75,255),
      LEVER: (8,7,5,255),
      LILAC: (70, 85, 64, 255),
      ACACIA_WOOD: (105,99,89,255),
      DARK_OAK_WOOD: (52,41,23,255),
      BIRCH_WOOD: (207,206,201,255),
      JUNGLE_WOOD: (87,68,27,255),
      STAIRS_WOOD: (102,81,50,255),
      WOOD: (102,81,50,255),
      SPRUCE_WOOD: (46,29,12,255),
      MAGMA: (135,66,26,255),
      MELON_BLOCK: (141,146,36,255),
      MOB_SPAWNER: (16,24,30,255),
      MOSS_STONE: (104, 121, 104, 255),
      ...
      WOOD_PLANKS_ACACIA: (169,92,51,255),
      WOOD_PLANKS_DARK_OAK: (61,40,18,255),
      WOOD_PLANKS_BIRCH: (196,179,123,255),
      WOOD_PLANKS_JUNGLE: (154,110,77,255),
      WOOD_PLANKS_OAK: (157,128,79,255),
      WOOD_PLANKS_SPRUCE: (104,78,47,255),
      ...
      RED_SANDSTONE_CHISELED: (162,83,28,255),
      RED_SANDSTONE: (166,85,30,255),
      RED_SANDSTONE_SMOOTH: (168, 86, 31, 255),
      REDSTONE_BLOCK: (171, 28, 9, 255),
      REDSTONE_LAMP_INACTIVE: (70,43,27,255),
      REDSTONE_LAMP_ACTIVE: (119,89,55,255),
      REDSTONE_ORE: (133,107,107,255),
      REDSTONE_TORCH_INACTIVE: (7,5,3,255),
      REDSTONE_TORCH_ACTIVE: (17,8,4,255),
      SUGAR_CANE: (82,106,56,255),
      REDSTONE_REPEATER_INACTIVE: (151,147,147,255),
      REDSTONE_REPEATER_ACTIVE: (161,147,147,255),
      ROSE_BUSH: (51, 50, 3, 255),
      SAND: (219,211,160,255),
      SANDSTONE_CHISELED: (216,208,155,255),
      SANDSTONE: (217,210,157,255),
      SANDSTONE_SMOOTH: (220,212,162,255),
      SAPLING_ACACIA: (41,46,9,255),
      SAPLING_BIRCH: (50,64,36,255),
      SAPLING_JUNGLE: (16,29,6,255),
      SAPLING: (30,43,16,255),
      SAPLING_DARK_OAK: (32,50,16,255),
      SAPLING_SPRUCE: (17,19,11,255),
      ...
      STONE_BUTTON: (125,125,125,255),
      STONE_ANDESITE: (131, 131, 131, 255),
      STONE_ANDESITE: (131,131,131,255),
      STONE_ANDESITE_SMOOTH: (133, 133, 135, 255),
      STONE_ANDESITE_SMOOTH: (133,133,135,255),
      STONE_DIORITE: (180, 180, 183, 255),
      STONE_DIORITE: (180,180,183,255),
      STONE_DIORITE_SMOOTH: (183, 183, 186, 255),
      STONE_DIORITE_SMOOTH: (183,183,186,255),
      STONE_GRANITE: (153, 114, 99, 255),
      STONE_GRANITE: (153,114,99,255),
      STONE_GRANITE_SMOOTH: (159, 115, 98, 255),
      STONE_GRANITE_SMOOTH: (159,115,98,255),
      STONE_SLAB: (167,167,167,255),
      STONE_SLAB_DOUBLE: (167,167,167,255),
      STONE_BRICK: (122,122,122,255),
      STONE_BRICK_CHISELED: (119,119,119,255),
      STONE_BRICK_CRACKED: (119,119,119,255),
      STONE_BRICK_MOSSY: (115,119,106,255),
      ...
      VINE: (60,60,60,255),
      WATER_FLOWING: (49,72,244,255),
      WATER_STATIONARY: (47,67,244,255),
